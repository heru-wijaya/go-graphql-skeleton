...
type QueryResolver interface {
	Products(ctx context.Context, id *string) ([]*Product, error)
}
...
func (ec *executionContext) _Query_Products(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Product)
	fc.Result = res
	return ec.marshalNProduct2ᚕᚖgithubᚗcomᚋheruᚑwijayaᚋgoᚑgraphqlᚑskeletonᚋdummyᚐProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNProduct2ᚕᚖgithubᚗcomᚋheruᚑwijayaᚋgoᚑgraphqlᚑskeletonᚋdummyᚐProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*Product) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProduct2ᚖgithubᚗcomᚋheruᚑwijayaᚋgoᚑgraphqlᚑskeletonᚋdummyᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProduct2ᚖgithubᚗcomᚋheruᚑwijayaᚋgoᚑgraphqlᚑskeletonᚋdummyᚐProduct(ctx context.Context, sel ast.SelectionSet, v *Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
